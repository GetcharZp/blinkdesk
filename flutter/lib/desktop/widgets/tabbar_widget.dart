...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (blinkDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await blinkDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
...
class AddButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionIcon(
        ...
        icon: IconFont.add,
        onTap: () => blinkDeskWinManager.call(

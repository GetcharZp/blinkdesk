...
class BlinkDeskMultiWindowManager {
  BlinkDeskMultiWindowManager._();

  static final instance = BlinkDeskMultiWindowManager._();
  ...
  /// `blinkDeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final blinkDeskWinManager = BlinkDeskMultiWindowManager.instance;

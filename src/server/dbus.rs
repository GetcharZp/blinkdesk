...
const DBUS_NAME: &str = "org.blinkdesk.blinkdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "BlinkDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.blinkdesk.blinkdesk /dbus org.blinkdesk.blinkdesk.NewConnection string:'PEER_ID'`
